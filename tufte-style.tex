...
% \renewcommand{\marginpar}[1]{\originalmarginpar{\mbox{}{#1}}}
...
\long\def\@makefntext#1{\@textsuperscript{\@tufte@sidenote@font\footnotesize\@thefnmark}\,\footnotelayout#1}
...
\long\def\@tufte@sidenote[#1][#2]#3{%
  ...
  \kern\multiplefootnotemarker\relax% add new \kern here to replace it
}
